...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><div class="col-lg-6 lpadding"><label for="text">QTY</label><input type="number" name="mytextt[]" placeholder="QTY" class="form-control"/></div><div class="col-lg-6"><label for="text">Size</label><input type="text" name="mytextt[]" placeholder="Size" class="form-control"/></div><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
