          ...
          <form method="post" action = "{{url('/')}}/vendor/home/add/product" class="login-form" enctype="multipart/form-data">
           ...
           <label for="text">Inactive?</label>
                    ...
                    <div class="form-group"> 
                      ...
                      <img id="blah" src="{{url('/')}}/vendor/images/demo.png" alt="your image" style="width:350px; height:300px;" /> </div>
                    <div class="form-group">
                      <input type="file" name="images2" class="form-control" onchange="preview_image(this);"/>
                      <img id="blah2" src="{{url('/')}}/vendor/images/demo.png" alt="your image" style="width:350px; height:300px;"/> </div>
                    <div class="form-group">
                      <input type="file" name="images3" class="form-control" onchange="preview_img(this);"/>
                      <img id="blah3" src="{{url('/')}}/vendor/images/demo.png" alt="your image" style="width:350px; height:300px;"/> </div>
                    <div class="form-group">
