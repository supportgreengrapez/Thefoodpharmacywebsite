   ...
   <div class="">
     ...
     <div class="row">
       ...
       @if($result>0)
                       ...
                       <form method="post" action = "{{url('/')}}/vendor/home/edit/product/{{$result[0]->pk_id}}" class="login-form" enctype="multipart/form-data">
                         {{ csrf_field() }}
             @if($errors->any())
           ...
           <div class="productbox">
             <div class=" col-md-6">
               <div class="form-login">
                 ...
                 <input type="text" name="sku" value="{{$result[0]->SKU}}" class="form-control input-sm chat-input" placeholder="SKU"/>
                 <label for="text">Name</label>
                 <input type="text" name="name" value="{{$result[0]->name}}" class="form-control input-sm chat-input" placeholder="Name" />
                 <label for="text">Price</label>
                 <input type="text" name="price" value="{{$result[0]->price}}" class="form-control input-sm chat-input" placeholder="Price" />
...
<img id="blah4" src="{{url('/')}}/storage/images/{{$result[0]->thumbnail4}}" alt="your image" style="width:180px; height:180px;"/>
                   ...
                   <textarea class="form-control" value="{{$result[0]->description}}" name="description" rows="9" id="comment" >{{$result[0]->description}}</textarea>
                 </div>
                 <br>
