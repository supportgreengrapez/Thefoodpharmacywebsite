...
<div class="container">
  <div class="row">
    <div class="col-12">
      <div class="tab-list-option mb-50"> @php  
        ...
        $data =  DB::table('bank_slips')->where('user_id',$id)->get();
        ...
        <ul class="nav">
          ...
          <li> <a href="{{route('create.payment')}}">Create Payment</a> </li>
          <li> <a href="#" data-toggle="modal" data-target="#basicExampleModal">Bank account details</a> </li>
...
<div class="modal fade" id="basicExampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <h3>Pakistan and international payments</h3>
        <h4>Standard Chartered Bank</h4>
        <h5>Account Title : The Food Pharmacy</h5>
        <h5>Account number : PK55 SCBL 0000001732136501</h5>
        <h5>Branch code : 137</h5>
      </div>
  ...
  <div class="row justify-content-center">
    <div class="col-md-3 col-sm-12 col-xs-12" >
      ...
      <div class="text-center mt-10 mb-20">
        <button  disabled class="btn-coaching text-center">Schedule</button>
      </div>
    </div>
    <div class="col-md-3 col-sm-12 col-xs-12">
      <div class="coaching text-center"> <img src="{{url('client/img/Untitled-6.png')}}" alt="img"> </div>
      <div class="text-center mt-10 mb-20">
        <button disabled="" class="btn-coaching text-center">Health History</button>
      </div>
    </div>
    <div class="col-md-3 col-sm-12 col-xs-12">
      <div class="coaching text-center"> <img src="{{url('client/img/Untitled-7.png')}}" alt="img"> </div>
      <div class="text-center mt-10 mb-20">
        <button  disabled="" class="btn-coaching text-center">Diet Plan</button>
      </div>
    </div>
  </div>
  @php }else{ @endphp
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-md-3 col-sm-12 col-xs-12">
      <div class="coaching text-center"> <img src="{{url('client/img/Untitled-6.png')}}" alt="img"> </div>
      <div class="text-center mt-10 mb-20"> <a href="{{route('question.answer.form')}}" class="btn-coaching text-center">Health History</a> </div>
    </div>
    <div class="col-md-3 col-sm-12 col-xs-12">
      <div class="coaching text-center"> <img src="{{url('client/img/Untitled-7.png')}}" alt="img"> </div>
      <div class="text-center mt-10 mb-20"> <a href="{{route('view.assigned.diet')}}" class="btn-coaching text-center">Diet Plan</a> </div>
    </div>
  </div>
  @php } @endphp 
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="pricingTable">
                  ...
                  <ul  class="content-list">
                    <li><img src="{{url('/')}}/client/img/DOT.png" alt='img'> <span class="green">1st session </span> health history 
                      via WhatsApp video phone call.</li>
                    <li><img src="{{url('/')}}/client/img/DOT.png" alt='img'> <span class="green">2nd session: </span>1st diet plan and 
                      recipe discussion during the session.
                      30-40 mins</li>
                    <li><img src="{{url('/')}}/client/img/DOT.png" alt='img'> <span class="green">3rd session: </span>discussion of progress, weight,
                      and any issues arising. From 
                      this information I will make your,
                      next diet plan.</li>
                    <li><img src="{{url('/')}}/client/img/DOT.png" alt='img'> <span class="green">4th session: </span>discussion of progress,
                      weight, and any issues arising with
                      health. From this information I will
                      make your next diet plan with
                      minor changes.</li>
                    <li><img src="{{url('/')}}/client/img/DOT.png" alt='img'> <span class="green">5th session: </span>discussion of progress,
                      weight and any other issues arising
                      with health. From this information
                      I will make your next diet plan with
                      minor changes.</li>
                  </ul>
                </div>
              </div>
