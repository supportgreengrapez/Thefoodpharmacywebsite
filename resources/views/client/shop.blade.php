      ...
      <div class="col-lg-3 order-2 order-lg-1"> 
          ...
          <div class="category-menu">
            ...
            <div id="cate-toggle" class="category-menu-list">
              ...
              @foreach($main_category as $results)
                ...
                <li class="right-menu"><a href="">{{$results->main_category}}</a> 
        ...
        <div class="shop-sidebar">
          ...
          <div class="rc-product">
            <ul>
              <li>
                <div class="rc-product-thumb img-full"> <a href="single-product.html"><img src="{{URL('/')}}/client/img/product/product13.jpg" alt=""></a> </div>
                <div class="rc-product-content">
                  <h6><a href="single-product.html">Ornare sed consequat</a></h6>
                  <div class="rc-product-review"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> </div>
                  <div class="rc-product-price"> <span class="price">$66.00</span> </div>
                </div>
              </li>
              <li>
                <div class="rc-product-thumb img-full"> <a href="single-product.html"><img src="{{URL('/')}}/client/img/product/product12.jpg" alt=""></a> </div>
                <div class="rc-product-content">
                  <h6><a href="single-product.html">Condimentum posuere</a></h6>
                  <div class="rc-product-review"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> </div>
                  <div class="rc-product-price"> <span class="price">$72.00</span> </div>
                </div>
              </li>
              <li>
                <div class="rc-product-thumb img-full"> <a href="single-product.html"><img src="{{URL('/')}}/client/img/product/product12.jpg" alt=""></a> </div>
      ...
      <div class="col-lg-9 order-1 order-lg-2">
        <div class="shop-layout"> 
          ...
          <div class="breadcrumb-one mb-120">
            <div class="breadcrumb-img"> <img src="{{URL('/')}}/client/img/page-banner/shop-banner-1.jpg" alt=""> </div>
            ...
            <div id="myTabContent-2" class="tab-content">
              <div id="grid" class="tab-pane fade show active">
                <div class="product-grid-view">
                  <div class="row"> @if(count($result)>0)
                    @foreach($result as $results)
                    <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4"> 
                      <!--Single Product Start-->
                      <div class="single-product mb-25">
                        <div class="product-img img-full"> <a href="{{URL('/')}}/products/details/{{$results->pk_id}}/{{$results->SKU}}"> <img src="{{URL('/')}}/storage/images/{{$results->thumbnail}}" alt=""> </a> <span class="onsale">Sale!</span>
                    ...
                    @endif </div>
                     ...
                     <div class="row"> @if(count($d)>0)
                    @foreach($d as $results)
                    <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4"> 
                      <!--Single Product Start-->
                      <div class="single-product mb-25">
                        <div class="product-img img-full"> <a href="{{URL('/')}}/products/details/{{$results->pk_id}}/{{$results->SKU}}"> <img src="{{URL('/')}}/storage/images/{{$results->thumbnail}}" alt=""> </a> <span class="onsale">{{$results->percentage}} % OFF</span>
                        ...
                        <div class="product-content">
                          <h2><a href="{{URL('/')}}/products/details/{{$results->pk_id}}/{{$results->SKU}}">{{$results->name}}</a></h2>
                          <div class="product-price"> 
                            <div class="price" style="float:none;"> PKR {{number_format($results->price - (($results->price*$results->percentage)/100))}}<span>PKR {{number_format($results->price)}}</span> </div>
                            <div class="add-to-cart"> <a href="#">Add To Cart</a> </div>
                          </div>
                        </div>
                      </div>
