    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12 col-12">
          <form  method="POST" action="{{ route('guest.question.answer.form.submit') }}" >
            @csrf
            <div class="checkbox-form">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>Address  </label>
                    <input placeholder=""  name ="adress"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                ...
                <div class="col-md-4">
                  <div class="checkout-form-list">
                    ...
                    <input  class="form-control" name="currentWeigt" type="number">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="checkout-form-list">
                    <label>Weight 6 Month Ago </label>
                    <input class="form-control" name="weightSixMonthBefore" type="number">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="checkout-form-list">
                    <label>Weight 1 Year Ago </label>
                    <input class="form-control" name="weighOneYearBefore" type="number">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                  ...
                  <div id="div1" class="hide">
                    ...
                    <div class="col-md-12">
                      <div class="checkout-form-list">
                        ...
                        <input placeholder="" name="children"  type="number">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="checkout-form-list">
                ...
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    Yes
                    <input type="radio" name="helathProblem" value="no"/>
                    No </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>What is your blood type?</label>
                    <select  name="bloodGroop">
                ...
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    Yes
                    <input type="radio" name="controlpills" value="no"/>
                    No </div>
                </div>
                <div id="femaleonlyDiv" class="col-md-12">
                  <div  class="checkout-form-list">
                    <label>(Females only) Describe your menstrual cycle.</label>
                    <input placeholder="" id="femaleonly" name="menstrualCycle"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    <input placeholder="" name="allergiesOrSensitivities"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>How long has it been this way?</label>
                    <input placeholder="" name="howLongAllergiesOrSensitivities"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    Yes
                    <input type="radio" name="foodAllergies" value="no"/>
                    No </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    Yes
                    <input type="radio" name="physicallyActive" value="no"/>
                    No </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    Yes
                    <input type="radio" name="dailyExercise" value="no"/>
                    No
                ...
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    <input placeholder="" name="foodTiming"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    <input placeholder=""  name="exerciseFrom" type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>Describe your portion size?</label>
                    <input placeholder="" name="exercisePortionSize"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>How much water do you drink in the day?</label>
                    <input placeholder="" name="waterQuantity"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    <input placeholder="" value="" name="consumeDrinkFrom" type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>Do you have any major addiction?</label>
                    <input placeholder=""  value="" name="addiction" type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>Food or sugar or drugs?</label>
                    <input placeholder="" value="" name="foodSugarDrugs"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    <label>Do you eat out a lot, or cook at home ?</label>
                    <input placeholder="" value="" name="eatFrom" type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                   ...
                   <input type="radio" name="dailyEatMoreWhenUpset" value="yes"/>
                    Yes
                    <input type="radio" name="dailyEatMoreWhenUpset" value="no"/>
                    No
                    <!-- <textarea class="form-control" rows="9"></textarea> -->
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    <input placeholder="" name="teachMore"  type="text">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="checkout-form-list">
                    ...
                    Yes
                    <input type="radio" name="relevantInfo"  id="relevantInfoNo" value="no"/>
                    No
                    <!-- <textarea class="form-control" name="relevantInfoDescription" rows="9"></textarea> -->
                  </div>
                </div>
