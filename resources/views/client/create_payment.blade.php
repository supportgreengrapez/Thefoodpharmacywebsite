  ...
  <strong></strong>Physical coaching not available for now due to current pandemic. Thank you.
    ...
    <div class="row justify-content-center">
      <div class="col-md-2 col-sm-12 col-xs-12">
        ...
        <!-- <form action="{{url('user/bank-slip') }}" method="POST"> -->
        <form  class="form-horizontal" method="POST" action="{{route('bank.slipp') }}">
          <input type="hidden" name="package" value="Live Coaching">
          <input type="hidden" name="price" value="5000">
          @csrf
        <div class="text-center mt-10 mb-20"><input class="btn-coaching text-center" type="submit" value="Submit"> <!-- <button type="submit" class="btn-coaching text-center">Submit</button> --> </div>
        </form>
      </div>
      <div class="col-md-2 col-sm-12 col-xs-12">
        <div class="feature-content text-center">
        ...
        <div class="arrow-right  d-none d-sm-block"></div>
         <form action="{{url('user/bank-slipp') }}" method="POST">
         @csrf
         <input type="hidden" name="package" value="Physical Coaching">
          <input type="hidden" name="price" value="5000">
        <div class="text-center mt-10 mb-20">
            <input class="btn-coaching text-center" type="submit" value="Submit" disabled> 
        <!--<button type="submit" class="btn-coaching text-center" disabled>Submit</button> -->
        </div>
      </form>
      </div>
    </div>
